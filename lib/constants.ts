...
export const TASKS = [
  { name: '早睡早起',       icon: 'Moon',      desc: '12 前入睡，早上 7 前起床' },
  { name: '破曉打拳',       icon: 'Dumbbell',  desc: '日出後 10 分鐘內完成' },
  { name: '丹氣跑步 15 分鐘', icon: 'Activity', desc: '雨天可室內跑步' },
  { name: '曬太陽',          icon: 'Sun',       desc: '陰雨天不計分' },
  { name: '工作 8 小時',    icon: 'Briefcase', desc: '月累計 160 小時以上' },
  { name: '不吃肉',          icon: 'Leaf',      desc: '各素食級別皆可' },
  { name: '寫觀心書',        icon: 'BookOpen',  desc: '一階可寫覺察日記' },
  { name: '淨心功法',        icon: 'Wind',      desc: '睡前效果更好' },
] as const
